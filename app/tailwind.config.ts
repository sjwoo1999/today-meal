...
export default {
	...
	theme: {
		...
		extend: {
			colors: {
				// ===== Design System v3.1: Soft & Readable =====
				// Primary: Soft Green (채도를 낮추고 명도를 높임)
				green: {
					'50': '#F0FDF4',
					'100': '#DCFCE7',
					'200': '#BBF7D0',
					'300': '#86EFAC',
					'400': '#4ADE80',  // 주요 액센트 (기존 500 대체)
					'500': '#34D399',  // 더 부드러운 녹색
					'600': '#10B981',
					'700': '#059669',
					'800': '#047857',
					'900': '#065F46',
				},
				// Secondary: Soft Blue (더 편안한 파랑)
				blue: {
					'50': '#EFF6FF',
					'100': '#DBEAFE',
					'200': '#BFDBFE',
					'300': '#93C5FD',
					'400': '#60A5FA',  // 더 부드러운 기본 파랑
					'500': '#4B9EF8',  // 채도 낮춤
					'600': '#2563EB',
					'700': '#1D4ED8',
					'800': '#1E40AF',
